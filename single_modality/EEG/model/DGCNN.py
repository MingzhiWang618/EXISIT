...
class DGCNN(nn.Module):
    def __init__(self, num_electrodes=30, in_channels=5, num_classes=3, k=2, relu_is=1, layers=None, dropout_rate=0.5):
        ...
        self.layers = layers if layers is not None else ([64] if num_electrodes == 62 else [128])
        self.k = k
    ...
    def print_params(self):
        ...
        print("{:45}{:20}".format("dropout rate:", self.dropout_rate))
        print("{:45}{:20}".format("num_electrodes:", self.num_electrodes))
        print("{:45}{:20}".format("in_channels:", self.in_channels))
        print("{:45}{:20}\n".format("num_classes:", self.num_classes))
